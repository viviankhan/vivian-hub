        ...
        <div style={{ display:'flex', gap:8, marginBottom:16, flexWrap:'wrap', alignItems:'center' }}>
          ...
          {doneCount > 0 && (
            confirmClear ? (
              ...
              <button onClick={() => setConfirmClear(true)} style={{ fontSize:11, padding:'5px 12px', borderRadius:20, border:'1px solid #FECACA', background:'#FFF5F5', color:'#991B1B', cursor:'pointer', fontFamily:'DM Sans,sans-serif', fontWeight:600, marginLeft:'auto' }}>
