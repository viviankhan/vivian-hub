...
const GLYPHS = {
  ...
  rocket:  { el: <>{P("M12 3c3 2.2 4.5 5.3 4.5 8.8 0 2.2-1 4.3-4.5 7-3.5-2.7-4.5-4.8-4.5-7C7.5 8.3 9 5.2 12 3Z")}<circle cx="12" cy="10" r="1.9"/>{P("M9.2 16.5 6.5 21l3.4-1.4M14.8 16.5 17.5 21l-3.4-1.4")}</> },
